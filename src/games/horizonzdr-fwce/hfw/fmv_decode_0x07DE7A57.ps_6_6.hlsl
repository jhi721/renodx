...
float4 main(
  ...
  if (_89) {
    ...
    float _136 = max(9.999999717180685e-10f, _135);
    float _137 = max(9.999999717180685e-10f, _132);
    float _138 = max(9.999999717180685e-10f, _133);
    float _139 = max(9.999999717180685e-10f, _134);
    float _140 = log2(_137);
    float _141 = log2(_138);
    float _142 = log2(_139);
    float _143 = _140 * _136;
    float _144 = _141 * _136;
    float _145 = _142 * _136;
    float _146 = exp2(_143);
    float _147 = exp2(_144);
    float _148 = exp2(_145);
    _159 = expansion.mapped;
    float _160 = _159 * _146;
    float _161 = _159 * _147;
    float _162 = _159 * _148;
    float _163 = min(_160, expansion.cap);
    float _164 = min(_161, expansion.cap);
    float _165 = min(_162, expansion.cap);
    _167 = _163;
    _168 = _164;
    _169 = _165;
  } else {
