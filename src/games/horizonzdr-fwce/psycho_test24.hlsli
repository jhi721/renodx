#ifndef SRC_GAMES_HORIZONZDR_FWCE_PSYCHO_TEST24_HLSLI_
#define SRC_GAMES_HORIZONZDR_FWCE_PSYCHO_TEST24_HLSLI_
...
//
// bleaching_intensity, clip_point, hue_restore, white_curve_mode,
// adaptive_normalization, and highlight_saturation are accepted to keep the
// psychov call signature but are not read by this implementation: the adaptive-MB
// interpolation subsumes the hue stage, and there is no bleaching or white-curve
// stage to drive. Callers must not assume those effects are applied.
...
#endif  // SRC_GAMES_HORIZONZDR_FWCE_PSYCHO_TEST24_HLSLI_
