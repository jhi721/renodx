...
//
// RenoDX replaces cHDROutputControl's cap (.w) with EvaluateNativeExpansionLuma's Peak / Game
// Brightness ceiling; the boost (.y) is read as vanilla and the Shadows soft knee (.z) is ignored.
